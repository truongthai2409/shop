    ...
    <div className="page-container">
      ...
      <div className="relative col-span-1">
        ...
        <div className="grid grid-cols-2 gap-4">
          <img src="/img01@2x.png" alt="Fashion Image 1" className="object-cover w-full h-full aspect-square"/>
          <img src="/img02@2x.png" alt="Fashion Image 2" className="object-cover w-full h-full aspect-square"/>
          <img src="/img03@2x.png" alt="Fashion Image 3" className="object-cover w-full h-full aspect-square"/>
          <img src="/img04@2x.png" alt="Fashion Image 4" className="object-cover w-full h-full aspect-square"/>
        </div>
        </div>
    </div>
  );
